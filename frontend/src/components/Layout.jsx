...
const navLinks = [
    {
        to: '/', label: 'Tổng quan', permission: 'dashboard:read',
        icon: (
    ...
    {
        to: '/orders', label: 'Đơn hàng', permission: 'orders:list',
        icon: (
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
        to: '/products', label: 'Sản phẩm', permission: 'products:list',
        icon: (
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
        to: '/inventory', label: 'Kho hàng', permission: 'inventory:list',
        icon: (
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
        to: '/customers', label: 'Khách hàng', permission: 'customers:list',
        icon: (
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    return (
        <div className="min-h-screen bg-[#0a0e1a] flex">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <Modal open={profileOpen} onClose={() => setProfileOpen(false)} title="Hồ sơ" size="sm">
                    <div className="space-y-5">
                        ...
                        <button onClick={handleLogout} className="w-full flex items-center justify-center gap-2 px-4 py-1.5 rounded-xl bg-red-500/15 text-red-400 hover:bg-red-500/25 font-medium transition-colors">
